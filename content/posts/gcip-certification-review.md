...
ผมใช้เวลาสอบเกือบ 3 ชั่วโมงเต็ม (น่าจะเหลือเวลาประมาณ 10 นาที) พอตอบข้อสุดท้ายเสร็จ ระบบก็แจ้งผลสอบมาบนหน้าจอเลย ไม่ต้องรอลุ้นให้ proctor พรินท์ผลสอบแต่อย่างใด สรุปว่าสอบผ่าน ได้ GIAC Certification ใบที่สองมาครอบครองต่อจาก [GRID](/posts/grid-certification-review/) 🎉

## GCIP Exam Tips

1. ผมรู้สึกตั้งแต่ตอนทำ Practice Test ทั้ง 2 ชุด ว่าข้อสอบ GCIP เป็นข้อสอบที่แปลกกว่าข้อสอบ certification ด้านไซเบอร์อื่นๆ ที่เคยสอบมา เข้าใจว่าน่าจะเพราะเป็นการทดสอบ "ความรู้ความเข้าใจเกี่ยวกับมาตรฐาน" ไม่ใช่ทดสอบความรู้ความเข้าใจด้านไซเบอร์อย่างที่ตัวเองคุ้นเคย 😑
2. ถ้าอ่านโจทย์แล้วไม่รู้ว่าควรไปเปิดเล่มไหน หัวข้อไหน หรือหาใน index แล้วไม่เจอ แนะนำให้กด Skip ข้อนั้นไปก่อน แล้วค่อยย้อนกลับมาทำ (ในการสอบอนุญาตให้ Skip ได้ทั้งหมด 10 ข้อ)
