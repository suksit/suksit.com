...
อยู่มาวันนึงช่วงประมาณต้นเดือน พ.ค. 65 ผมก็เห็นประกาศของ สกมช. ร่วมกับ (ISC)² Bangkok Chapter เรื่องหลักสูตรระดับผู้เชี่ยวชาญเฉพาะด้าน เป็นโปสเตอร์หน้าตาแบบนี้
...
ก็เลยอ้าว มันเป็นอันที่เคยไปสมัครเรียนไว้นี่หว่า เลยคิดว่าไหนๆ ก็จะฟังอยู่แล้ว ถือโอกาสสอบ certification ไปด้วยเลยดีไหม ฟรีตลอดรายการอีกต่างหาก 🤔
...
การสอบคัดเลือกรอบที่หนึ่ง ผมไปสอบแบบไม่ได้เตรียมตัวใดๆ กะว่าเป็นการวัดไปในตัวว่าด้วยความรู้ที่มีตอนนั้น จะมีคุณสมบัติพอได้ไปต่อไหม เท่าที่จำได้คือมีคนสมัครประมาณ 1,200 คน แล้วคัดเหลือ 600 คน ข้อสอบเป็นภาษาไทย คาดว่าจะจัดทำโดย สกมช. เอง

สรุปว่าได้เป็น 1 ใน 600 คนที่ได้ไปต่อ
...
การสอบคัดเลือกรอบที่สอง เริ่มรู้สึกตัวว่าถ้ายังชิลๆ อยู่ น่าจะยากละ แต่ตอนนั้นไม่มี materials ใดๆ เกี่ยวกับ CISSP ในมือเลย (พร้อมมาก 😒) เลยใช้วิธีดูคลิป 2022 FRSecure CISSP Mentor Program ที่ดองไว้ โดยใช้เวลาในช่วงตั้งแต่ตื่นนอน ระหว่างกินข้าว แต่งตัว ก่อนออกไปทำงาน ประมาณ 10 วัน ก็ได้เฉลี่ยวันละ domain พอดี
...
ประกาศผลออกมา ปรากฏว่าได้ไปต่อ !!! เป็น 1 ใน 60 candidates น้ำตาจะไหล ทีแรกนึกว่าตกรอบเรียบร้อย เพราะได้เมลแจ้งผลช้ามาก สงสัยเพราะคะแนนกากเลยอยู่ท้ายๆ มีไปดราม่าไว้นิดหน่อยด้วย 555+
...
ก่อนถึงช่วง Official (ISC)² Training Seminar for CISSP มีเวลาประมาณ 2 สัปดาห์ ก็นั่งอ่าน OSG ไปเรื่อยๆ จนถึงวันที่ต้องเรียน เหมือนเพิ่งอ่านไปได้แค่ 6-7 chapter จากทั้งหมด 21 chapter ตอนไปนั่งเรียนก็เลยเหมือนฟัง introduction ในแต่ละเรื่องที่ยังไม่ได้อ่าน มากกว่าจะเป็นการทบทวนความเข้าใจ 😅
...
**Bootcamp ตะลุยข้อสอบ** เข้าใจว่ารูปแบบก็คงเป็นได้ประมาณนั้น คือเอาข้อสอบมาให้ดูเยอะๆ แล้วก็เฉลย/อธิบายกันไป โดยส่วนตัวไม่แน่ใจว่า 5 วันนี่นานไปไหม แต่อย่างหนึ่งที่ผมรู้สึกคือ คำถามที่ใช้ใน bootcamp ไม่ควรเป็นคำถามเชิง definition และไม่ควรแยกติวราย domain ถ้าอยากให้ผู้สอบได้ประสบการณ์ที่ใกล้เคียงกับการสอบจริง อาจจะลองคัดเฉพาะคำถามที่เป็นการวิเคราะห์ ใช้ความรู้จากหลายๆ domain และไม่เป็นเชิงเทคนิคมากไป มาถาม-ตอบ หรือวิเคราะห์กัน น่าจะมีประโยชน์มากขึ้น

## Slaying the Beast

ช่วงประมาณ 1 เดือนก่อนสอบ CISSP ผมพยายามสร้างความมั่นใจให้ตัวเอง โดยการไปสอบ Certified in Cybersecurity (CC) ที่เปิดให้สอบฟรีตามโครงการ [1MCC](https://www.isc2.org/landing/1MCC) ของ (ISC)² ต่อด้วย CompTIA Security+ ที่ได้สิทธิ์สอบจาก สกมช. ผลคือผ่านทั้งคู่ 🤪

สำหรับประสบการณ์การสอบ CISSP และสรุป materials ที่ผมใช้ สามารถดูได้ที่โพสต์ [CISSP Exam Preparation Review](/posts/cissp-exam-preparation-review/) ครับ
