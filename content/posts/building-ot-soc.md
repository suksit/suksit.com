...
Bruce เล่าถึงแนวทางในการบริหารจัดการ SOC สำหรับระบบ OT โดยแบ่งเนื้อหาเป็น 4 เรื่องหลักๆ ได้แก่ people, process, technology, และ resources
...
* เราจะจัดทำแหล่งความรู้สำหรับสมาชีกใหม่ในทีมได้ยังไง
...
* ควรใช้ controlled document framework (เอกสารที่มีกระบวนการ authorized, review, etc. เช่นพวก procedures, standards) ควบคู่ไปกับไปกับการทำ KB ทั้งนี้ความรู้บางอย่างจาก KB อาจจะขยับไปอยู่ใน controlled document ได้
* ควรหาวิธีเก็บ KB ให้ปลอดภัย เพราะเป็นข้อมูลสำคัญที่ผู้ไม่หวังดีสามารถเอาไปใช้ประโยชน์ได้ และต้องคิดเผื่อกรณีที่เราอาจไม่สามารถเข้าถึง KB ได้ตามปกติ จะทำยังไงให้ทีม SOC ยังคงมีข้อมูลที่จำเป็นในการทำงานได้

### Detection Engineering
* เป็นกระบวนการที่ทำให้ use case สอดคล้องกับ security activiies อื่นๆ เช่น risk assessment, cyber threat intelligence, project work, thrreat hunting เป็นต้น
* สร้าง use case ยังไงให้ analyst เอาไป take action ต่อได้
  ...
  * กำหนดประเภทของ rules
    ...
    * Anomaly อาจจะเป็นแค่ noise เฉยๆ ลองเช็คดูอีกที
...
* ควรผสมกันระหว่าง operation metrics และ improvement metrics (OKRs)
...
* ถ้าไม่รู้จะเริ่มสร้าง OT SOC จากตรงไหน Bruce แนะนำให้เริ่มจาก OT DMZ
...
* อาจจะเริ่มลองจาก network security monitoring tools ที่เป็น open source ก่อนก็ได้
...
* เราจะได้ข้อมูลจำนวนมากในการเอาไปทำ Detection Engineering ต่อ
* สร้างความมั่นใจให้ทีม SOC ว่าระบบสามารถตรวจจับการโจมตีที่เกิดขึ้นได้
