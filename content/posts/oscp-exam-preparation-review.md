...
ผมเก็บแล็บ OSCP A, B, C ไว้เล่นทีหลังสุด ตอนใกล้ๆ คอร์สหมดอายุ เพื่อเป็นการวัดความพร้อมของตัวเองก่อนสอบจริง... โดย block เวลาเอาไว้ 24 ชั่วโมงในแต่ละสัปดาห์ สำหรับเล่นแต่ละแล็บ และจำลองว่าเป็นการสอบจริง ตั้งนาฬิกาทำ Pomodoro โดยพักเป็นช่วงๆ ตามที่วางแผนไว้ (จริงจังไปไหน 555+ 🤪)
...
ตอนเล่นเครื่องพวกนี้ช่วงแรกๆ ผมจะกังวลในการพยายามมองให้ออกว่า ต้องเริ่มจาก port ไหน ระบบไหนที่ควรโจมตี และจะพยายามรีบหา CVE number หรือ exploit เพื่อให้ได้ flag เร็วที่สุด จะได้ไปติ๊กใน list ว่าผ่านแล้ว และไปเล่นเครื่องต่อไป...

แต่ตอนเล่นช่วงหลังๆ จะเริ่มรู้สึกเหมือนมีโหมด autopilot 💀 พอถึงเวลาก็รัน VM ขึ้นมา ต่อ VPN แล้วทำตาม methodology ไปตามลำดับ เพื่อรวบรวมข้อมูลเกี่ยวกับเครื่องนั้นๆ ให้ได้มากที่สุด ก่อนพยายามโจมตีจริงๆ

สิ่งที่สังเกตได้อีกอย่างคือผมจะไม่ค่อยรู้สึกกังวลว่าจะเจาะเครื่องนี้ได้หรือไม่ได้อีกต่อไป ซึ่งไม่ได้แปลว่าผมเจาะระบบสำเร็จทุกครั้ง แต่เหมือน ยอมรับ / ปลงได้ กับความจริงที่ว่า
...
นอกจาก Cheatsheet ที่รวมคำสั่งที่ต้องใช้ ผมจะมี note อีกแผ่นนึงชื่อ "When Stuck" ไว้จดว่าผมเคยติดตรงไหน แล้วทำยังไงถึงไปต่อได้ เอาไว้เปิดหาไอเดียวิธีโจมตีเวลาเล่นเครื่องต่อๆ ไป ถ้าติดอีกก็มาเขียนเพิ่มไปเรื่อยๆ
