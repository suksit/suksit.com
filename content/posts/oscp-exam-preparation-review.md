...
โดยผมเลือกเล่นเฉพาะเครื่องที่อยู่ใน Proving Grounds กับ Hack Smarter และไม่ได้เล่นเครื่องที่อยู่ใน HTB เลย เพราะรู้สึกว่าสไตล์โจทย์มันต่างจากของ OffSec 🤔

ทั้งสองลิสด์จะมีเครื่องที่ซ้ำกันพอสมควร รวมๆ แล้วผมน่าจะเล่นไปประมาณ 120 เครื่อง ในช่วงเวลาประมาณ 3 เดือนก่อนสอบ โดยใช้เวลาช่วงกลางคืนหลังเลิกงาน รวมทั้งในวันหยุดเสาร์-อาทิตย์
...
ตอนเล่นเครื่องพวกนี้ช่วงแรกๆ ผมจะกังวลในการพยายามหาว่าต้องเริ่มจาก port ไหน ระบบไหนที่ควรโจมตี และจะพยายามรีบหา CVE number หรือ exploit เพื่อให้ได้ flag เร็วที่สุด จะได้ไปติ๊กใน list ว่าผ่านแล้ว และไปเล่นเครื่องต่อไป...

แต่ช่วงหลังๆ จะเริ่มรู้สึกคล้ายๆ ว่าตัวเองเป็นเครื่องจักร 💀 ทำตาม methodology ไปตามลำดับ เพื่อรวบรวมข้อมูลเกี่ยวกับเครื่องนั้นๆ ให้ได้มากที่สุด ก่อนพยายามโจมตีจริงๆ และไม่ค่อยรู้สึกกังวลว่าจะเจาะเครื่องนี้ได้หรือไม่ได้อีกต่อไป ซึ่งไม่ได้แปลว่าผมเจาะระบบสำเร็จทุกครั้ง แต่เหมือน ยอมรับ / ปลงได้ กับความจริงที่ว่า

> Sometimes you don't know what you don't know.

ถ้าเจอ service / port / config อะไรแปลกๆ หรือไม่คุ้นเคย ก็ google เอา หรือลองหาใน [HackTricks](https://hacktricks.wiki/) อะไรทำนองนี้ แต่ถ้าทำแล้วยังไปต่อไม่ถูก ก็ใช้ไม้ตาย เปิด walkthrough 😝 ดูแบบแง้มๆ ว่ามันไปต่อทางไหน แล้วก็ลองงมต่อเอง

นอกจาก Cheatsheet ที่รวมคำสั่งที่ต้องใช้ ผมจะมี note อีกแผ่นนึงชื่อ "When Stuck" ไว้จดว่าผมเคยติดตรงไหน แล้วทำยังไงถึงไปต่อได้ เอาไว้มาเปิดดูเวลาเล่นเครื่องต่อๆ ไป ถ้าติดอีกก็มาเขียนเพิ่มไปเรื่อยๆ
...
อีกเรื่องที่เกี่ยวกับ mindset น่าจะเป็นเรื่องของความ "พร้อมที่จะสอบ" สำหรับผมเองรู้สึกว่าค่อนข้างตรงกับประโยคนึงที่เหมือนพูดเล่นกันขำๆ [ตอนเตรียมตัวสอบ CISSP](/posts/cissp-exam-preparation-review)
...
**[UV](https://github.com/astral-sh/uv)** เป็น tool โคตรเทพในการทำงานกับ Python 🤩 ผมใช้ฟีเจอร์หลักๆ อยู่ 2 อย่าง คือ
...
ดูตัวอย่างการใช้งาน uv สำหรับงานด้าน pentest ได้ที่[บล็อกของ 0xdf](https://0xdf.gitlab.io/cheatsheets/uv)

**[RustHound-CE](https://github.com/g0h4n/RustHound-CE/)** เอาไว้ query ข้อมูลจาก Domain Controller เพื่อเอาไป import ใน BloodHound อีกที โดยปกติถ้ารัน SharpHound บนเครื่องเป้าหมายไม่ได้ ผมจะรัน RustHound-CE บน Kali เป็นตัวเลือกที่สอง

**[Ligolo-NG](https://github.com/nicocha30/ligolo-ng)** เครื่องมือทำ pivoting ไว้ใช้ตอนเจาะระบบ Active Directory Set ทำให้สามารถเข้าถึงเครื่องที่อยู่ใน internal network ได้โดยไม่ต้องใช้ proxychains และใช้งานง่ายกว่า Chisel มากๆ 😍

**[fzf](https://github.com/junegunn/fzf)** เอาไว้ค้นหาคำสั่งที่เคยพิมพ์ไปแล้ว จริงๆ zsh ใน Kali ก็มี auto suggestion อยู่ แต่มันจะแนะนำแค่คำสั่งล่าสุดที่ใช้ ถ้าต้องการหาคำสั่งย้อนหลัง ผมว่า fzf ช่วยได้เยอะ สำหรับผมรู้สึกว่าเร็วกว่าไปเปิด cheatsheet พอสมควร 🙃

**[SysReptor](https://github.com/Syslifters/sysreptor)** เอาไว้เขียน penetration testing report ด้วย Markdown พร้อมสร้าง PDF หน้าตาสวยงาม ใช้แล้วชีวิตดีกว่าการนั่งพิมพ์ด้วย Microsoft Word... มีทั้งเวอร์ชันที่รันแบบ local หรือ on cloud และมี [report design สำหรับ OffSec Exam](https://github.com/Syslifters/OffSec-Reporting) เตรียมไว้ให้เรียบร้อย

**[SiYuan](https://github.com/siyuan-note/siyuan)** เอาไว้จดโน้ตทั้งตอนเรียน ตอนทำแล็บ และตอนสอบ แต่ก่อนผมใช้ Obsidian เป็นหลัก แต่รู้สึกว่ามันมีอะไรตะหงิดๆ อยู่ตลอดเวลา (ซึ่งก็อธิบายไม่ได้ว่าคืออะไร) เคยลองเปลี่ยนมาหลายยี่ห้อ สุดท้ายมาเจอ SiYuan รู้สึกว่าใช้แล้วคลิกกว่า Obsidian และรู้สึกสบายใจ เลยใช้ตัวนี้มาตลอด 😌
