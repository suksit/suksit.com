...
ประโยชน์จากการเล่นเครื่องพวกนี้ คือการสร้าง methodology ในการทดสอบเจาะระบบของตัวเอง และการเรียนรู้ท่าใหม่ๆ ที่อาจจะไม่ได้มีสอนในคอร์ส PEN-200 รวมไปถึงช่วยฝึกความอดทนในการพยายามเจาะระบบ ที่อาจจะต้องใช้เวลาเครื่องละ 1-3 ชั่วโมง
...
แต่ช่วงหลังๆ จะเริ่มรู้สึกคล้ายๆ ว่าเป็นหุ่นยนต์ 🤖 ทำตาม methodology ไปตามลำดับ เพื่อรวบรวมข้อมูลเกี่ยวกับเครื่องนั้นๆ ให้ได้มากที่สุด ก่อนพยายามโจมตีจริงๆ และไม่ค่อยรู้สึกกังวลว่าจะเจาะเครื่องนี้ได้หรือไม่ได้อีกต่อไป ซึ่งไม่ได้แปลว่าผมเจาะระบบสำเร็จทุกครั้ง แต่เหมือน ยอมรับ / ปลงได้ กับความจริงที่ว่า
...
เอาไว้จดโน้ตทั้งตอนเรียน ตอนทำแล็บ และตอนสอบ แต่ก่อนผมใช้ Obsidian เป็นหลัก แต่รู้สึกว่ามันมีอะไรตะหงิดๆ อยู่ตลอดเวลา (ซึ่งก็อธิบายไม่ได้ว่าคืออะไร) เลยลองเปลี่ยนมาใช้ SiYuan รู้สึกว่าใช้แล้วคลิกกว่า Obsidian และรู้สึกสบายใจ เลยใช้ตัวนี้มาตลอด 😌
