...
เนื่องจาก[ผมเคยพลาดเรื่องนี้มาครั้งนึง](/posts/self-presentation) คราวนี้เลยพอมีแนวทางว่าควรจะนำเสนอตัวเองยังไงให้ดูน่าสนใจ โดยผมทำ resume ส่งไป 2 แผ่น และก็คิดว่าน่าจะมาถูกทาง เพราะได้เป็น 1 ใน 50 คนที่ได้รับการพิจารณาให้เข้ารอบที่ 3 😁
...
**อบรมเชิงปฏิบัติการ (OSCP Pre-Bootcamp)** ระยะเวลา 2 วัน แบบ on-site เนื้อหาเกี่ยวกับกระบวนการทดสอบเจาะระบบที่ลงลึกและเข้มข้นกว่ารอบที่ 1 และ 2 โดยทาง Secure D ได้ให้สิทธิ์เข้าเรียนหลักสูตร Road to OSCP ใน SECPlayground แก่ผู้เข้ารอบทั้ง 50 คน เพื่อเข้าไปทำ lab ในระหว่างการอบรม โดยเงื่อนไขการผ่านรอบนี้เพื่อเข้ารอบที่ 4 คือ
...
> 
> เหตุผลคือ ทุกคนจะได้เรียนรู้ / ทำความคุ้นเคย กับการทดสอบเจาะระบบผ่าน VPN ซึ่งใกล้เคียงกับการสอบจริง และช่วยลดปัญหาจากภายนอก เช่น ISP มีการบล็อกบาง port จากอินเทอร์เน็ต รวมทั้งจะไม่มีประเด็นเรื่องการได้คะแนนระดับ Ultimate, Gold, Silver, ฯลฯ ที่มักจะทำให้เกิดคำถามเกี่ยวกับแนวทางการพิจารณาผลทุกครั้ง...
...
**อบรม OSCP Bootcamp** ระยะเวลา 5 วัน แบบ on-site เป็นการอบรมแบบ bootcamp อย่างเป็นทางการ ผู้เข้าอบรมจะได้ voucher หลักสูตร PEN-200 ที่เข้าไปเรียนได้ 90 วัน และมี voucher สอบ OSCP ให้ 1 ใบ รอบนี้ทาง Secure D จัดอบรมโดยรวมกลุ่มคนที่ได้รับทุนจาก สกมช. ทั้ง 8 คน กับกลุ่มคนที่ซื้อคอร์สเองตามปกติ มานั่งอบรมด้วยกันเลย

โดยส่วนตัวผมไม่มีประเด็นกับการจัดคอร์สแบบนี้ เพราะรู้สึกว่ามีคนเรียนเยอะๆ ก็ดี จะได้มีคนช่วยถาม และน่าจะได้ฟังความคิดเห็น / มุมมอง ที่หลากหลายกว่านั่งเรียนกันแค่ 8 คน
