...
สิ่งที่พบบ่อยๆ คือ คนส่วนใหญ่รู้และเข้าใจว่าระบบ IT แตกต่างจากระบบ OT โดยระบบ IT ให้ความสำคัญกับ information ส่วนระบบ OT ให้ความสำคัญกับ operation หรือ physical process

แต่เหมือนจะมีเพียงคนส่วนน้อยที่เข้าใจว่า context ของ CIA ในมุมของ IT และ AIC ในมุมของ OT มันเป็นคนละเรื่องกัน 😑
