...
ที่น่าสนใจคือ Profile เหล่านี้ไม่ได้กำหนดไว้ตายตัว แต่เราสามารถจับแต่ละ Layer แยกออกเป็นส่วนๆ แล้วมาเชื่อมต่อกันได้ตามโครงสร้างของระบบที่แต่ละองค์กรมีอยู่ ตัวอย่างเช่น การใช้ Profile ของ Control Center ตั้งแต่ Layer 3–5 เพียงตัวเดียว แต่ใช้ Profile ในส่วนของ Physical Assets Zone หลายตัว (จากภาพตัวอย่างเป็น Generation Profile และ Substation Profile) เพื่อให้สอดคล้องกับระบบต่างๆ ที่มีการใช้งานอยู่จริง ตามภาพด้านล่าง
