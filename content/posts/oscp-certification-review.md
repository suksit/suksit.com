...
รูปแบบการสอบจะเป็นการทำ network penetration testing พร้อมเขียน report โดยแบ่งโจทย์ออกเป็นสองส่วนใหญ่ๆ
...
ผมวางแผนสอบโดยเริ่มจาก Active Directory Set เพราะอย่างน้อยต้องได้ 10 คะแนนจาก AD ถึงจะสอบผ่าน และถ้าสามารถ compromise AD ได้ทั้ง set เราจะได้ 40 คะแนน ซึ่งถ้าได้ตรงนี้เราจะมีทางเลือกในการโจมตีเครื่อง standalone เพื่อให้ได้คะแนนถึงเกณฑ์ผ่านค่อนข้างเยอะ เช่น
...
> ถ้าถามว่ามันเป็น rabbit hole หรือเปล่า ในมุมผมมองว่าไม่ใช่ เพราะผมรู้ว่าช่องทางการโจมตีมันคือตรงนี้แหละ แต่มันขาดยัง jigsaw บางชิ้นที่จะทำให้โจมตีได้สำเร็จ
