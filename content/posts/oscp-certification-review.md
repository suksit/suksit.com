...
และผมวางแผนการสอบโดยเริ่มจากการโจมตี Active Directory Set ก่อน เพราะเป็น 40 คะแนนที่ควรต้องเคลียร์ให้ได้ ไม่งั้นคะแนนรวมไม่ถึง 70 แน่นอน
...
ผ่านไปประมาณ 9 ชั่วโมง... ถึงตรงนี้จริงๆ ก็คือได้คะแนนถึงเกณฑ์ผ่านแล้ว เลยเริ่มเขียนรายงาน ทำไปเรื่อยๆ จนถึงประมาณสี่ทุ่มกว่าๆ ก็คุยกับตัวเองว่า นี่เราทำเต็มที่แล้วจริงๆ ใช่ไหม พอใจแล้วใช่ไหม
...
ตื่นมาอีกทีเพราะตั้งนาฬิกาปลุกไว้ตอน 7 โมงเช้า สะลึมสะลือมานั่งทำต่อ ได้แนวทางการโจมตีระหว่างนอนมาอีก 2-3 แบบ แต่ไม่เวิร์ก ใช้เวลาไปอีก 2 ชั่วโมง โดยไม่ได้คะแนนเพิ่มแต่อย่างใด จนถึงช่วงประมาณ 45 นาทีสุดท้ายก่อนหมดเวลา ผมก็ Google ไปเจอทางสว่างแบบงงๆ 😱
...
แน่นอนว่าจังหวะนั้นคือมือไม้สั่น รีบเก็บ screenshot เป็นหลักฐาน แล้วเช็คข้อมูลทุกอย่างอีกรอบ ก่อนบอก proctor ว่าขอจบการสอบ ตอนประมาณ 9 โมงครึ่งของวันที่ 23 เม.ย. ด้วยคะแนน 90/100

หลังจากนั้นก็พักแป๊บนึง แล้วเริ่มเขียนรายงานต่อ กะว่าค่ำๆ น่าจะเสร็จ แต่ปรากฎว่าลากยาวไปจนเกือบเที่ยงคืน และได้ส่งรายงานตอนเที่ยงคืนกว่าๆ ของวันที่ 24 เม.ย. สรุปใช้เวลาเขียนรายงานไปประมาณ 12 ชั่วโมง

## The Result

หลังจากส่งรายงานแล้ว วันต่อมาผมก็นั่ง refresh หน้า portal ของคอร์ส PEN-200 😆 จนประมาณบ่ายสามโมงกว่าๆ ก็มีอัปเดตว่า congratulations คุณสอบผ่านแล้วนะ ส่วนอีเมลที่แจ้งว่าผ่านแบบเป็นทางการ จะมาหลังจากนั้น โดยผมได้เมลตอนเที่ยงคืนกว่าๆ ของอีกวัน ถ้านับจากตอนส่งรายงาน ก็ประมาณ 24 ชั่วโมงพอดี
